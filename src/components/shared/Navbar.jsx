...
export default function Navbar() {
  ...
  return (
    <Disclosure as="nav" id="navbar" className={`fixed h-auto top-0 w-full z-50`}>
      {({ open }) => (
        <>
          <div className={`  border-b-4 transition-colors duration-300  pb-4 ${isScrolled && !mobileMenuShown ? 'border-gray-300 bg-Dark-Navy' : ' border-transparent md:bg-Dark-Navy'} ${mobileMenuShown ? 'bg-Dark-Navy' : ' '}`}>
