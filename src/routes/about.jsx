...
export default function About() {
  ...
  return (
    <div id="about" className="overflow-hidden" >
      ...
      <div id="whoweare" className='relative grid grid-cols-1 lg:grid-cols-2 items-center h-screen bg-about-gradient'>
      ...
      <div id="what we do" className='relative grid grid-cols-1 lg:grid-cols-2 items-center h-screen bg-about-gradient'>
    ...
    <div id="timeline" className='relative w-screen'>
      <div className= 'absolute inset-0 z-10 h-full w-full bg-repeat bg-center ' style={{backgroundImage: `url(${noise}`}}></div>
      <div className='absolute inset-0 h-full w-full blue-gradient'></div>
